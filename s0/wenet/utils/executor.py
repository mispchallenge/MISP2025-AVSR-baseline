    ...
    def train(self, model, optimizer, scheduler, data_loader, device, writer,
        ...
        with model_context():
            for batch_idx, batch in enumerate(data_loader):
                ...
                # print(key, feats.shape, target.shape, feats_lengths, target_lengths)
                # key:['S192_M005_S192193194_F8N_Near_192_159728-159752', 'S192_M005_S192193194_F8N_Near_192_024644-024668']
                # feats.shape: torch.Size([2, 6, 96, 96, 3]) 
                # target.shape: torch.Size([2, 1]) 
                # feat_lengths: tensor([6, 6], dtype=torch.int32) 
                # target_lengths: tensor([1, 1], dtype=torch.int32)
                ...
                with context():
                    ...
                    # if torch.isnan(loss):
                    #     print(key)
                    #     log_str_nan = 'LOSS NAN:{}!'.format(loss.item())
