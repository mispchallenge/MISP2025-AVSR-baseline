    ...
    for sample in data:
        ...
        try:
            if 'start' in obj:
                ...
                # waveform  type:torch.tensor shape:(1,X) 
                # sample  type:int 16000
                # tensor([[ 0.0001,  0.0002,  0.0000,  ..., -0.0032, -0.0030, -0.0034]])  torch.float32
...
def resample(data, resample_rate=16000):
    ...
    for sample in data:
        ...
        # tensor([[ 0.0001,  0.0002,  0.0000,  ..., -0.0032, -0.0030, -0.0034]])
        yield sample
