...
import wenet.dataset.processor_misp2022_avsr as processor
...
def Dataset_AV_n_m(data_type,
    ...
    shuffle = conf.get('shuffle', True)
    dataset = DataList(lists, shuffle=shuffle, partition=partition)
    dataset = Processor(dataset, processor.parse_raw_av_n_m)
