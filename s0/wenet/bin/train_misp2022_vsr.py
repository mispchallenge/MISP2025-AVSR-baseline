...
from wenet.dataset.dataset_misp2022 import Dataset_Visual
from wenet.utils.checkpoint_gm import (load_checkpoint, save_checkpoint,
                                    load_trained_modules, load_pretrain_modules,load_visual_pretrain_modules)
from wenet.utils.executor import Executor
from wenet.utils.file_utils import read_symbol_table, read_non_lang_symbols
from wenet.utils.scheduler import WarmupLR, NoamHoldAnnealing
from wenet.utils.config import override_config
from wenet.utils.init_model_misp2022_vsr import init_model_misp2022_vsr
...
def main():
    ...
    train_dataset = Dataset_Visual(args.data_type, args.train_data, symbol_table,
                                   train_conf, args.bpe_model, non_lang_syms, True)
    cv_dataset = Dataset_Visual(args.data_type,
                                args.cv_data,
                                symbol_table,
                                cv_conf,
                                args.bpe_model,
    ...
    model = init_model_misp2022_vsr(configs)
    #print(model)
    ...
    if args.checkpoint is not None:
        ...
        # print(type(device))    # 注释 torch.device
        infos = load_visual_pretrain_modules(model, init_param, name_map, device)
