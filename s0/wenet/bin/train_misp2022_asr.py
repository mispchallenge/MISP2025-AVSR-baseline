...
from wenet.dataset.dataset_misp2022 import Dataset
...
from wenet.utils.init_model_misp2022_asr import init_model_misp2022_asr
...
def main():
    ...
    model = init_model_misp2022_asr(configs)
    print(model)
