...
from wenet.dataset.dataset_misp2022_avsr import Dataset_AV_n_m
...
def main():
    ...
    train_dataset = Dataset_AV_n_m(args.data_type, args.train_data, symbol_table,
                            train_conf, args.bpe_model, non_lang_syms, True)
    cv_dataset = Dataset_AV_n_m(args.data_type,
                         args.cv_data,
                         symbol_table,
                         cv_conf,
                         args.bpe_model,
