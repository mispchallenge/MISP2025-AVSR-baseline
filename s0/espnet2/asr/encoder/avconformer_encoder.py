...
from espnet2.asr.encoder.avchannel_wise_encoder import AttentionKQVFusion
# from network_audio_visual_fusion import AudioVisualFuse
...
if __name__ == "__main__":
    ...
    # yaml_path = "/yrfs2/cv1/hangchen2/espnet/mispi/avsr/conf/avsr/AVCrossAttentionEncoder2.yaml"
    # import yaml 
    # with open(yaml_path) as f :
    #     cfg = yaml.safe_load(f)
    # encoder_conf = cfg["encoder_conf"]
    ...
    # yaml_path = "/yrfs2/cv1/hangchen2/espnet/mispi/avsr/conf/avsrfinetune/AVTMCTCConformerEncoder0ivsr.yaml"
    # import yaml 
    # with open(yaml_path) as f :
    #     cfg = yaml.safe_load(f)
    # encoder_conf = cfg["encoder_conf"]
    ...
    yaml_path = "/yrfs2/cv1/hangchen2/espnet/mispi/avsr/conf/avsrfinetune/AVTMSeqConformerEncoder0ivsr.yaml"
    import yaml 
    with open(yaml_path) as f :
        cfg = yaml.safe_load(f)
    encoder_conf = cfg["encoder_conf"]
    ...
    # yaml_path = "/yrfs2/cv1/hangchen2/espnet/mispi/avsr/conf/avsrfinetune/newcross/AVffnConformerEncoder0ivsr_lipfmid_triphone02.yaml"
    # import yaml 
