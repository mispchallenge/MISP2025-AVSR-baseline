...
if __name__ == "__main__":
    ...
    # frontend = VideoFrontend(resnettype="common").cuda()
    # modelpath = "/yrfs2/cv1/hangchen2/espnet/mispi/avsr/exp/vsr_pretrainmodel/nopain_lipresnet.pth"
    # name_map = {"frontend3D":"video_frontend","resnet18":"resnet"}
    # load_pretrained_model(modelpath,frontend,ignore_init_mismatch=True,map_location="cuda",name_map=name_map)
    # # v_tensor = torch.rand(16,100,1,88,88).cuda()
    # feats = torch.rand(16,55,96,96,3).cuda()  #121, 96, 96, 3
    # lengths = torch.randint(55,56,(16,)).cuda()
    # output,output_length = frontend(feats,lengths)
    # print(output.shape)
